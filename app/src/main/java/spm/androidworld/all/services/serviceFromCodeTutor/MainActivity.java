package spm.androidworld.all.services.serviceFromCodeTutor;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MyCodeTutorService myService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_codetutor);
        ...
        serviceIntent = new Intent(getApplicationContext(), MyCodeTutorService.class);
        ...
        if (serviceConnection == null) {
            serviceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    MyCodeTutorService.MyServiceBinder myServiceBinder = (MyCodeTutorService.MyServiceBinder) iBinder;
